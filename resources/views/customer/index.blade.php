                            ...
                            @foreach ($customers as $customer)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="javascript:;" onclick="if(confirm('are you sure?')) $('.form-{{ $customer->id }}').submit()"
                                        ...
                                        <a href="{{ route('images.show', $customer->id) }}" style="color: #2c2c2c;"
                                            class="ms-1 me-1"><i class="far fa-receipt"></i></a>
                                    </td>
                                </tr>
                            @endforeach
